...
namespace WeDoALittleQualityOfLife.Content.Recipes
{
    internal static class GlobalRecipes
    {
        public static void AddRecipes()
        {
            ...
            Condition ShimmerCondition = new Condition("Shimmer", WDALQOLConditionFunctions.GetFalse);
        ...
        {
            Condition AnkhShieldCondition = new Condition("Ankh Shield in Inventory", WDALQOLConditionFunctions.HasAnkhShieldInInventory);
            ...
            Condition CellPhoneCondition = new Condition("Cell Phone in Inventory", WDALQOLConditionFunctions.HasCellPhoneInInventory);
            ...
            Condition TerrasparkBootsCondition = new Condition("Terraspark Boots in Inventory", WDALQOLConditionFunctions.HasTerrasparkBootsInInventory);
            ...
            Condition ArcticDivingGearCondition = new Condition("Arctic Diving Gear in Inventory", WDALQOLConditionFunctions.HasArcticDivingGearInInventory);
            ...
            Condition CelestialCuffsCondition = new Condition("Celestial Cuffs in Inventory", WDALQOLConditionFunctions.HasCelestialCuffsInInventory);
            ...
            Condition CelestialEmblemCondition = new Condition("Celestial Emblem in Inventory", WDALQOLConditionFunctions.HasCelestialEmblemInInventory);
            ...
            Condition CelestialShellCondition = new Condition("Celestial Shell in Inventory", WDALQOLConditionFunctions.HasCelestialShellInInventory);
            ...
            Condition FireGauntletCondition = new Condition("Fire Gauntlet in Inventory", WDALQOLConditionFunctions.HasFireGauntletInInventory);
            ...
            Condition FrogGearCondition = new Condition("Frog Gear in Inventory", WDALQOLConditionFunctions.HasFrogGearInInventory);
            ...
            Condition LavaproofTackleBagCondition = new Condition("Lavaproof Tackle Bag in Inventory", WDALQOLConditionFunctions.HasLavaproofTackleBagInInventory);
            ...
            Condition MasterNinjaGearCondition = new Condition("Master Ninja Gear in Inventory", WDALQOLConditionFunctions.HasMasterNinjaGearInInventory);
            ...
            Condition SniperScopeCondition = new Condition("Sniper Scope in Inventory", WDALQOLConditionFunctions.HasSniperScopeInInventory);
        ...
        public static void AddBiomeKeyDuplicationRecipes()
        {
            ...
            .AddCondition(new Condition("Piranha Gun in Inventory", WDALQOLConditionFunctions.HasPiranhaGunInInventory))
            .AddCustomShimmerResult(ItemID.PiranhaGun, 1)
            .Register();

            Recipe.Create(ItemID.ScourgeoftheCorruptor, 1)
            .AddIngredient(ItemID.CorruptionKey, 1)
            .AddCondition(new Condition("Scourge of the Corruptor in Inventory", WDALQOLConditionFunctions.HasScourgeoftheCorruptorInInventory))
            .AddCustomShimmerResult(ItemID.ScourgeoftheCorruptor, 1)
            .Register();

            Recipe.Create(ItemID.VampireKnives, 1)
            .AddIngredient(ItemID.CrimsonKey, 1)
            .AddCondition(new Condition("Vampire Knives in Inventory", WDALQOLConditionFunctions.HasVampireKnivesInInventory))
            .AddCustomShimmerResult(ItemID.VampireKnives, 1)
            .Register();

            Recipe.Create(ItemID.RainbowGun, 1)
            .AddIngredient(ItemID.HallowedKey, 1)
            .AddCondition(new Condition("Rainbow Gun in Inventory", WDALQOLConditionFunctions.HasRainbowGunInInventory))
            .AddCustomShimmerResult(ItemID.RainbowGun, 1)
            .Register();

            Recipe.Create(ItemID.StaffoftheFrostHydra, 1)
            .AddIngredient(ItemID.FrozenKey, 1)
            .AddCondition(new Condition("Staff of the Frost Hydra in Inventory", WDALQOLConditionFunctions.HasStaffoftheFrostHydraInInventory))
            ...
            .AddCondition(new Condition("Desert Tiger Staff in Inventory", WDALQOLConditionFunctions.HasStormTigerStaffInInventory))
